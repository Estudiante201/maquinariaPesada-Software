<?php
			...
			$sql=$conexion->query("SELECT * FROM mantcorrectivo mc, equipos eq WHERE mc.idEquipo = eq.idEquipo AND mc.idMantCorrectivo=$id");
        ...
        <section class="full-box page-content">
            ...
            <div>
				<ul class="full-box list-unstyled page-nav-tabs" style="margin:0; padding:0">
					<li  style="margin:0; padding:0">
						<a class="active" href="manten_correctivo.php"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO MANTENIMIENTO CORRECTIVO</a>
					</li>
					<li  style="margin:0; padding:0">
						<a href="equipo.php"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO MANTENIMIENTO PREVENTIVO</a>
					</li>
					<li  style="margin:0; padding:0">
            ...
            <div class="container-fluid">
				<form action="" method="POST" class="form-neon" autocomplete="off">
							...
							<div class="row">
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label>Orden #</label>
										<input type="text" style="width:100%; color:#B2BABB; font-weight:bold" name="numOrden" value="<?php echo $numOrden ?>">
									</div>
								</div>
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="date" style="width:100%" name="fechaEmision" value="<?php echo $fechaEmision; ?>">
									</div>
								</div>
						...
						<div class="container-fluid">
							<div class="row">								
								...
								<legend style="background:#F4291F; color:white;">&nbsp; Descripcion del Problema (DIAGNOSTICO)</legend>
									<div class="form-group">
										<textarea name="diagnostico" rows="3" style="width:100%;"><?php echo $diagnostico ?></textarea>
									</div>
								</div>
								...
								<legend style="background:#772DF1; color:white;">&nbsp; Actividad (INTERVENCION Y REPARACION)</legend>
									<div class="form-group">
										<textarea name="actividad" rows="3" style="width:100%;"><?php echo $actividad ?></textarea>
									</div>
								</div>
							...
							<div class="row">								
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text" style="width:100%" name="nomTecnico" value="<?php echo $nomTecnico ?>">
									</div>
								</div>
								...
								<div class="col-12 col-md-2">
									<div class="form-group">
										...
										<input type="date" style="width:100%" name="fechaInicio" value="<?php echo $fechaInicio ?>">
									</div>
								</div>
								...
								<div class="col-12 col-md-2">
									<div class="form-group">
										...
										<input type="date" style="width:100%" name="fechaFinal" value="<?php echo $fechaFinal ?>">
									</div>
								</div>
					...
					<?php
            include("./modelo/backend_editar_mant_correctivo.php");
            ?>
				</form>
			</div>
        </section>
