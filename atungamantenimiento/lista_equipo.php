			...
			<div>
				<ul class="full-box list-unstyled page-nav-tabs" style="margin:0; padding:0">
					<li  style="margin:0; padding:0">
						<a href="equipo.php"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEGO EQUIPO</a>
					</li>
					<li  style="margin:0; padding:0">
						<a class="active" href="lista_equipo.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE EQUIPO</a>
					</li>
				</ul>	
			</div>
    ...
    ?>
	       ...
	       <tr class="text-center" >
				...
				<td style="text-align:center;">
					<?php echo "<a href='editar_equipo.php?id=".$resultado['idEquipo']."' class='btn btn-success' ><i class='fas fa-sync-alt'></i></a>"; ?>
				</td>

				<td style="text-align:center;">
					<?php echo "<a href='./modelo/backend_eliminarequipo.php?id=".$resultado['idEquipo']."' class='btn btn-warning' onclick='return eliminar()'><i class='far fa-trash-alt'></i></a>"; ?>
				</td>
