	...
	<main class="full-box main-container">
					...
					<ul>
						...
						<li>
							...
							<ul>
								...
								<li>
									<a href="lista_estado_mant.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; Lista Estado de Manten.</a>
								</li>
								<li>
		...
		<section class="full-box page-content">
			...
			<div class="full-box tile-container">
				...
				<a href="equipo.php" class="tile">
					<div class="tile-tittle">Equipo</div>
					<div class="tile-icon">
				...
				<a href="manten_correctivo.php" class="tile">
					<div class="tile-tittle">Manten. Correctivo</div>
					<div class="tile-icon">
				...
				<a href="manten_preventivo.php" class="tile">
					<div class="tile-tittle">Manten. Preventivo</div>
					<div class="tile-icon">
						<i class="fas fa-users fa-fw"></i>
						<p></p>
					</div>
				...
				<a href="#" class="tile">
					<div class="tile-tittle">Reporte</div>
					<div class="tile-icon">
